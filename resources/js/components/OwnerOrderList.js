...
const headRows = [
  { id: 'name', numeric: false, disablePadding: false, label: 'Guest Name' },
  { id: 'room', numeric: true, disablePadding: false, label: 'Room Number' },
  { id: 'checkin', numeric: true, disablePadding: false, label: 'Check-in Date' },
  { id: 'duration', numeric: true, disablePadding: false, label: 'Duration of Stay' },
  { id: 'checkout', numeric: true, disablePadding: false, label: 'Check-out Date' },
];
...
export default function OwnerOrderList() {
  ...
  useEffect(() => {
    const fetchOrder = async () => {
      const response = await axios.get(`/api/orderList/${JSON.parse(localStorage.getItem('user')).id}`)
